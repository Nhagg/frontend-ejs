    ...
    <div class="row">
      <div class="col text-center">
        <div class="speak-title">
          <h2>{{ 'Nhìn tranh và hoàn thành câu' }}</h2>
        </div>
      </div>
    </div>
    <div class="mt-2 text-center">
      <div class="item-list-answer">
        <img :src="$getItemImg(unit, item, 1)" @error="$errorImage" />
      </div>
      <div class="item-list-answer">
        <input
      ...
      <div
        ...
        class="text-center mt-2 fs-20 fw-500"
      >
        Đáp án chính xác:
      </div>
      <h2 v-if="checkedAnswer && userPoint == false" class="text-center mt-3">
...
<script>
export default {
  name: 'PracticeSeePictureCompleteScentence1',
  props: {
    setAnswer: {
      type: Function,
      default: Function
