...
export const actions = {
  async GET_LIST_COURSE({commit, state}) {
    ...
    await ApiService.get(window.DOMAIN_API + '/api/courses').then(
      res => {
  ...
  async GET_LIST_LESSON({commit, state}) {
    ...
    await ApiService.get(window.DOMAIN_API + '/api/lessions').then(
      res => {
  ...
  async GET_LIST_LEARN_UNIT({commit, state}) {
    ...
    await ApiService.get(window.DOMAIN_API + '/api/learn_units').then(
      res => {
